...
When such an investigation finds that $r \gg 2$ is required, as we have in different scientific applications, some guidance on whether DFR is still feasible or whether alternatives need to be considered could be provided.
